...
export class InitialMigration1729504041296 implements MigrationInterface {
    name = 'InitialMigration1729504041296'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "posts" ("id" SERIAL NOT NULL, "creatorWallet" character varying NOT NULL, "text" character varying NOT NULL, "createdAt" TIMESTAMP NOT NULL, "lastReplyDate" TIMESTAMP, "visibility" "public"."posts_visibility_enum" NOT NULL, "requestType" "public"."posts_requesttype_enum", "requestExpiration" character varying, "skillTags" character varying array NOT NULL DEFAULT '{}', "recipientWallets" character varying array NOT NULL DEFAULT '{}', "unreadByWallets" character varying array NOT NULL DEFAULT '{}', "likes" integer NOT NULL DEFAULT '0', "tips" integer NOT NULL DEFAULT '0', "replyToPostId" integer, "boostedUntil" TIMESTAMP(3) NOT NULL DEFAULT now(), CONSTRAINT "PK_2829ac61eff60fcec60d7274b9e" PRIMARY KEY ("id"))`);
